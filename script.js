...
const destinationList = [
  ...
  },
  {
    ...
    description:
      "Pour se reposer, quoi de mieux que le travail de la terre dans une cabane loin de toutes distractions ? Maria et son fils, Christian seront vos uniques voisins. Aussi accueillants que leurs chèvres, ils ne manqueront pas de vous initier à la confection du fromage cendré !",
  ...
  },
  {
    name: "L'hôtel Cortez",
    description:
      "Un séjour à vous glacer le sang, à ne pas en douter! Vous allez séjourner aux côtés de véritables célébrités ! Showcase spécial de Lady Gaga tous les mardis soirs !",
    img: "assets/Destination/hotelcortez.png",
  },
  {
    name: "Le Tartare",
    description:
      "Un incroyable supplice! Passage obligé par le stand de photo souvenir sur les piloris !",
  ...
  },
  {
    ...
    description:
      "Profitez de leurs nombreuses animations à bord, les pieds dans l'eau!",
